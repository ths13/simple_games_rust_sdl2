...
pub const MAX_X: u32 = SCENE_RANGE.width() / SPRITE_SIZE - 1;
pub const MIN_Y: u32 = 0;
pub const MAX_Y: u32 = SCENE_RANGE.height() / SPRITE_SIZE - 1;
...
impl Model {
    ...
    fn food_collision(&mut self) -> bool {
        let snake_head: &Position = self.snake.segments.front().unwrap();
...
pub fn main() {
    ...
    let mut simple_snake = SimpleSnake::new();
